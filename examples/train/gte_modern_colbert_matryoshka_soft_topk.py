"""Training GTE-ModernColBERT with MatryoshkaSoftTopKLoss.

Uses a fully differentiable soft sigmoid gate to weight document tokens
during training. At inference, hard top-k selection reduces the tensor.
"""
...
run_name = f"GTE-ModernColBERT-MatryoshkaSoftTopK-{lr}-lr-{num_train_epochs}-epochs"
