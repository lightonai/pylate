...
# Define model parameters for contrastive XTR training
...
run_name = "contrastive-xtr-modernbert-base"
...
# Define the loss function. The XTR objective is a drop-in `score_metric` swap on
# the standard contrastive loss. A lower-than-default temperature (0.05) helps
# offset the gradient sparsity introduced by XTR's masked top-k scoring.
