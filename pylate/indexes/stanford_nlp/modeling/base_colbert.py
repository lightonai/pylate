...
from pylate.indexes.stanford_nlp.modeling.hf_colbert import class_factory
...
if __name__ == "__main__":
    ...
    from pylate.indexes.stanford_nlp.infra.config import RunConfig
    ...
    with Run().context(RunConfig(gpus=2)):
        m = BaseColBERT(
            "bert-base-uncased",
            colbert_config=ColBERTConfig(Run().config, doc_maxlen=300, similarity="l2"),
        )
