...
???+ note
    PThe `lightonai/colbertv2.0` is the original [ColBERTv2 model](https://huggingface.co/colbert-ir/colbertv2.0/tree/main) made compatible with PyLate. We thank Omar Khattab for allowing us to share the model on PyLate.
